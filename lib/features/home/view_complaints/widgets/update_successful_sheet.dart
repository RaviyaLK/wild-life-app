...
class UpdateSuccessfulSheet extends StatefulWidget {
  const UpdateSuccessfulSheet({super.key});

  @override
  State<UpdateSuccessfulSheet> createState() => _UpdateSuccessfulSheetState();
}

class _UpdateSuccessfulSheetState extends State<UpdateSuccessfulSheet> {
    ...
    return AnimatedContainer(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('Your update to this complaint was saved Successfully!')
                .asHeading2()
                .colorRegular(),
            const SizedBox(
              height: 30,
