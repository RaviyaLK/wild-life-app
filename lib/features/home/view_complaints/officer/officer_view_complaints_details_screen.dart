...
import 'package:wild_life/features/home/view_complaints/widgets/update_status_sheet.dart';
...
class OfficerViewComplaintsDetailScreen extends StatefulWidget {
  static const path = '/officer-view-complaint-details';
  const OfficerViewComplaintsDetailScreen({super.key});

  @override
  State<OfficerViewComplaintsDetailScreen> createState() =>
      _OfficerViewComplaintsDetailScreenState();
}
...
class _OfficerViewComplaintsDetailScreenState
    extends State<OfficerViewComplaintsDetailScreen> {
  @override
                      ...
                      child: AppButton.primary(
                        ...
                        onPressed: () {
                          showModalBottomSheet(
                              ...
                              context: context,
                              builder: (_) {
                                return const UpdateStatusSheet();
                              });
                        },
                      ),
                    ),
